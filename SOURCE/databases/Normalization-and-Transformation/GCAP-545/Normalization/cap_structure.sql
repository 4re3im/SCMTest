...
--
-- Table structure for table `tab_accesses`
--

DROP TABLE IF EXISTS `tab_accesses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tab_accesses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tab_accesses_name_unique` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tabs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title_id` int(10) unsigned NOT NULL,
  `tab_access_id` int(10) unsigned DEFAULT NULL,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  ...
  KEY `tabs_tab_access_id_foreign` (`tab_access_id`),
  CONSTRAINT `tabs_tab_access_id_foreign` FOREIGN KEY (`tab_access_id`) REFERENCES `tab_accesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2019-10-30 16:13:46
