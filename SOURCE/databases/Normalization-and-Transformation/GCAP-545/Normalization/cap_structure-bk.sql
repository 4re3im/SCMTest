...
--
-- Table structure for table `content_accesses`
--

DROP TABLE IF EXISTS `content_accesses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `content_accesses` (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `content_accesses_name_unique` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tabs` (
  ...
  CONSTRAINT `tabs_content_access_id_foreign` FOREIGN KEY (`content_access_id`) REFERENCES `content_accesses` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2019-08-23 13:03:11
