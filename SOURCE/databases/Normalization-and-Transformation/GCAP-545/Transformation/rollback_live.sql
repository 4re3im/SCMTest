...
-- http://svn.cup.cam.ac.uk/repos/OnlineContent/anz/tng/go/branches/main-engineering/SOURCE/databases/Normalization-and-Transformation/master-normalization/Normalization/initial_tranformation_[env].sql