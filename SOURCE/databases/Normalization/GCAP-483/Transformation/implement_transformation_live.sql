...
-- Insert data so the trigger will be populating CAP data
	...
	-- CupContentSeries
	INSERT INTO `tngdb_tempo`.`CupContentSeries` SELECT * FROM `tngdb`.`CupContentSeries`;

	-- CupContentSeriesFormats
	INSERT INTO `tngdb_tempo`.`CupContentSeriesFormats` SELECT * FROM `tngdb`.`CupContentSeriesFormats`;
	...
	INSERT INTO `tngdb_tempo`.`CupContentSeriesSubjects` SELECT * FROM `tngdb`.`CupContentSeriesSubjects`;
	...
	-- CupContentTitle
	INSERT INTO `tngdb_tempo`.`CupContentTitle` SELECT * FROM `tngdb`.`CupContentTitle`;

	-- CupContentTitleAuthors
	INSERT INTO `tngdb_tempo`.`CupContentTitleAuthors` SELECT * FROM `tngdb`.`CupContentTitleAuthors`;

	-- CupContentTitleSamplePages
	INSERT INTO `tngdb_tempo`.`CupContentTitleSamplePages` SELECT * FROM `tngdb`.`CupContentTitleSamplePages`;

	-- CupContentTitleSubjects
	INSERT INTO `tngdb_tempo`.`CupContentTitleSubjects` SELECT * FROM `tngdb`.`CupContentTitleSubjects`;

	-- CupContentTitleRelatedTitle
	INSERT INTO `tngdb_tempo`.`CupContentTitleRelatedTitle` SELECT * FROM `tngdb`.`CupContentTitleRelatedTitle` cctrt WHERE cctrt.titleID IS NOT NULL AND cctrt.related_titleID IS NOT NULL;
	...
	INSERT INTO `tngdb_tempo`.`CupContentTitleSupportingTitle` SELECT * FROM `tngdb`.`CupContentTitleSupportingTitle`;
    
    -- CupGoBrandCodeTitles
	INSERT INTO `tngdb_tempo`.`CupGoBrandCodeTitles` SELECT * FROM `tngdb`.`CupGoBrandCodeTitles`;

	-- CupGoContentFolders
	INSERT INTO `tngdb_tempo`.`CupGoContentFolders` SELECT * FROM `tngdb`.`CupGoContentFolders`;

	-- CupGoContent
	INSERT INTO `tngdb_tempo`.`CupGoContent` SELECT * FROM `tngdb`.`CupGoContent`;

	-- CupGoContentDetail
	INSERT INTO `tngdb_tempo`.`CupGoContentDetail` SELECT * FROM `tngdb`.`CupGoContentDetail`;

	-- CupGoTabs
	INSERT INTO `tngdb_tempo`.`CupGoTabs` SELECT * FROM `tngdb`.`CupGoTabs`;

	-- CupGoTabContent
	INSERT INTO `tngdb_tempo`.`CupGoTabContent` SELECT * FROM `tngdb`.`CupGoTabContent`;
    
    -- CupContentTitleFormats
	INSERT INTO `tngdb_tempo`.`CupContentTitleFormats` SELECT * FROM `tngdb`.`CupContentTitleFormats`;
	SET FOREIGN_KEY_CHECKS = 1;
