...
<div class="page-header">
	<h1><?php echo t('Cambridge Go Account management')?></h1>
</div>
</div>
</div>
...
<?php if($changePasswordForm){ ?>
	...
	<form method="post" action="<?php echo $this->url( '/education/go_login', 'change_password', $uHash )?>"> 
...
<?php switch($_SESSION['uOpenIDError']) {
	case OpenIDAuth::E_REGISTRATION_EMAIL_INCOMPLETE: ?>
		...
		<form method="post" action="<?php echo $this->url('/education/go_login', 'complete_openid_email')?>">
	...
	?>
		...
		<form method="post" action="<?php echo $this->url('/education/go_login', 'do_login')?>">
...
<form method="post" action="<?php echo $this->url('/education/go_login', 'do_login')?>" class="form-horizontal ccm-login-form">
...
<form method="post" action="<?php echo $this->url('/education/go_login', 'forgot_password')?>" class="form-horizontal ccm-forgot-password-form">
<div class="row">
<div class="span10 offset1">
