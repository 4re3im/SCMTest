...
class EducationGoLoginController extends Controller {
    ...
    public function on_start() {
        ...
        $this->openIDReturnTo = BASE_URL . View::url("/go_login", "complete_openid");
    }
    ...
    public function forgot_password() {
        ...
        try {
            ...
            $changePassURL = BASE_URL . View::url('/go_login', 'change_password', $uHash);
        ...
        if ($loginData['success'] == 1) {
            $this->redirect('/education/go_login', 'password_sent');
        }
    }
