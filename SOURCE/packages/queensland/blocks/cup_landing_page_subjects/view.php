...
<?php foreach($config as $key => $each):?>
	<?php $ct++;?>
	<?php if($ct % 2 == 0):?>
	<div class="subject right" style="background:<?php echo $each["background_hex"];?>"
         bgc="<?php echo $each["background_hex"];?>">
	<?php else:?>
	<div class="subject left" style="background:<?php echo $each["background_hex"];?>"
         bgc="<?php echo $each["background_hex"];?>">
	<?php endif;?>
		<div class="frame">
