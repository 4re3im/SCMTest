...
$url = $th->getToolsURL('autocomplete', 'go_provisioning_hotmaths');
...
<div class="ccm-ui">
    <div class="ccm-pane">
        <div class="ccm-pane-header">
            <h3>Go Provisioning Hotmaths</h3>
        </div>
        <div class="ccm-pane-body">
            ...
            <div class="row">
                <div class="span11">
                    ...
                    <form id="subscriptions-form" method="POST"
                          action="<?php echo $this->url('/dashboard/provisioning_hotmaths/setup/startProvisioning'); ?>"
            ...
            <div class="row">
                <div class="span11">
                    <form action="/dashboard/provisioning_hotmaths/setup/exportToSheet/" method="POST">
