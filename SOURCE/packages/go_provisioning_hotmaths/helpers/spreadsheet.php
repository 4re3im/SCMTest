...
class SpreadsheetHelper
{
    ...
    {
        Loader::library('SpreadsheetReader/php-excel-reader/excel_reader2', 'go_provisioning_hotmaths');
        Loader::library('SpreadsheetReader/SpreadsheetReader', 'go_provisioning_hotmaths');
