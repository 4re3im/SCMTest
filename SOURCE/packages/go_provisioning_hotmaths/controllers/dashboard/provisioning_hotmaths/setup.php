...
class DashboardProvisioningHotmathsSetupController extends Controller
{
    ...
    {
        if (!$validator->validateEmail($record[ProvisioningHotmathsModel::COLUMN_EMAIL], $this->fileRecordId)) {
            throw new UnexpectedValueException('Invalid email.');
        }

        if (!$validator->validatePassword(
            $record[ProvisioningHotmathsModel::COLUMN_EMAIL],
            $record[ProvisioningHotmathsModel::COLUMN_PASSWORD],
            $this->fileRecordId
        )) {
        ...
        if (!$validator->validateGroup(
            $record[ProvisioningHotmathsModel::COLUMN_EMAIL],
            $record[ProvisioningHotmathsModel::COLUMN_USER_ROLE],
            $this->fileRecordId
        )) {
