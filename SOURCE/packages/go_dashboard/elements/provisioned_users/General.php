...
/**
 * General Tab for Provisioned Users
...
<form method='post' action="<?php echo $this->action('saveUserGeneralInfo'); ?>" name='usergeneral' id='usergeneral'>
    ...
    $u = new GoDashboardProvisionedUsers($data['ak_uMAStaffID']);
    $manually_added_by = $u->uName;

    if ($data['ak_uManuallyActivated']) {
        $manually_activated = $data['ak_uManuallyActivated'] == 1 ? 'Y' : 'N';
    }
    ...
    <form method='post' action=''>
        ...
        <div id='container2'>
            <div id='alertMessageDiv' class='' style='display:none'>
                    ...
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text' id='firstname' name='firstname'
                                   value="<?php echo $data['ak_uFirstName'] ?>">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text' id='lastname' name='lastname'
                                   value="<?php echo $data['ak_uLastName']; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>Email</td>
            ...
            <div class='panel'>
                ...
                <table id='tbl'>
                    ...
                    <tr>
                        <td id='hdr'>Active</td>
                        <td id='dtl'>
                            <?php $yes = $data['uIsActive'] == 1 ? 'CHECKED' : ''; ?>
                            <?php $no = $data['uIsActive'] == 0 ? 'CHECKED' : ''; ?>
                    ...
                    <tr>
                        ...
                        <td id="dtl">
                            <?php $isValidated = $data['uIsValidated'] == 1 ? 'CHECKED' : ''; ?>
                            <?php $notValidated = $data['uIsValidated'] <= 0 ? 'CHECKED' : ''; ?>
                            <input type='radio'
                                   name='verified'
                                   value='1' <?php echo $isValidated; ?>
                                   style='margin-right:5px'>Yes
                            <input type='radio'
                                   name='verified'
                                   value='0' <?php echo $notValidated; ?>
                                   style='margin-right:5px''>No
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <table id='tbl'>
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text' id='address' name='address'
                                   value="<?php echo $data['ak_uSchoolAddress'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>Suburb</td>
                        <td id='dtl'>
                            <input type='text' id='suburb' name='suburb' value="<?php echo $data['ak_uSuburb'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>State</td>
                        <td id='dtl'>
                            <?php if (trim($data['ak_uCountry']) != '' && trim($data['ak_uCountry']) != '-- Pick One --' &&
                                trim($data['ak_uCountry']) != 'Australia' && trim($data['ak_uCountry']) != 'New Zealand' &&
                                trim($data['ak_uCountry']) != 'Canada' && trim($data['ak_uCountry']) != 'United States') :
                                ?>
                                ...
                                <select id='state' name='state'>
                                    ...
                                    <?php foreach ($statesList as $state) { ?>
                                        <option value="<?php echo $state ?>"
                                            <?php if (trim($state) == trim($stateValue)) {
                    ...
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text' id='postcode' name='postcode'
                                   value="<?php echo $data['ak_uPostcode']; ?>">
                        </td>
                    </tr>
                    <tr>
                            ...
                            <select id='country' name='country' onchange="changeStateList(this.value);">
                                ...
                                <?php foreach ($countryList as $country) { ?>
                                    <option value="<?php echo $country ?>"
                                        <?php if (trim($data['ak_uCountry']) == trim($country)) {
                                            echo "selected='selected'";
                                        } ?> >
                                        <?php echo $country; ?>
                                    </option>
                    ...
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text'
                                   name='phonenumber'
                                   value="<?php echo $data['ak_uSchoolPhoneNumber']; ?>">
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class='panel' style="height:100%">
                ...
                <table id='tbl'>
                    <tr>
                        ...
                        <td id='dtl'>
                            <input type='text'
                                   id='position'
                                   name='position'
                                   value="<?php echo $data['ak_uPositionTitle'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>School</td>
                        <td id='dtl'>
                            <input type='text' id='school' name='school' value="<?php echo $data['ak_uSchoolName']; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>Title</td>
                        <td id='dtl'>
                            <input type='text' id='title' name='title' value="<?php echo $data['ak_uPositionType']; ?>">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td id='dtl'>
                            <?php $marketingCon = $ui->getAttribute('uCustomerCare') == "1" ? "CHECKED" : ""; ?>
                            <?php $notMarketingCon = $ui->getAttribute('uCustomerCare') == "0" ? "CHECKED" : ""; ?>
                            <input type='radio'
                                   name='customercare'
                                   value='1' <?php echo $marketingCon; ?>
                                   style='margin-right:5px''>Yes
                            <input type='radio'
                                   name='customercare'
                                   value='0' <?php echo $notMarketingCon; ?>
                                   style='margin-right:5px'>No
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id="dtl">
                            <?php $notpromotional_email = ($data['ak_uPMByEmail']) ? "" : "CHECKED"; ?>
                            <?php $promotional_email = ($data['ak_uPMByEmail']) ? "CHECKED" : ""; ?>
                            <input type='radio'
                                   name='promotional_email'
                                   value='1' <?php echo $promotional_email; ?>
                                   style='margin-right:5px'>Yes
                            <input type='radio'
                                   name='promotional_email'
                                   value='0' <?php echo $notpromotional_email; ?>
                                   style='margin-right:5px''>No
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id="dtl">
                            <?php $notpromotional_post = ($data['ak_uPMByRegularPost']) ? "" : "CHECKED"; ?>
                            <?php $promotional_post = ($data['ak_uPMByRegularPost']) ? "CHECKED" : ""; ?>
                            <input type='radio'
                                   name='promotional_post'
                                   value='1' <?php echo $promotional_post; ?>
                                   style="margin-right:5px">Yes
                            <input type='radio'
                                   name='promotional_post'
                                   value='0' <?php echo $notpromotional_post; ?>
                                   style="margin-right:5px">No
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td id="dtl">
                            ...
                            <input type='hidden'
                                   id='creationdate'
                                   name='creationdate'
                                   value="<?php echo $data['uDateAdded'] ?>">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id='dtl'>
                            ...
                            <input type='hidden'
                                   id='activateddate'
                                   name='activateddate'
                                   value="<?php echo $data['ak_uActivatedDate'] ?>"
                            >
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id='dtl'>
                            ...
                            <input type='hidden'
                                   ...
                                   value="<?php echo $data['ak_uManuallyActivated'] ?>">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td id='dtl'>
                            ...
                            <input type='hidden'
                                   id='manuallyactivatedby'
                                   name='manuallyactivatedby'
                                   value="<?php echo $data['ak_uMAStaffID']; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td id='hdr'>Notes</td>
    ...
    <div class="panel-default">
        <table width="100%" id="tbl" border="1">
            <tr>
                ...
                <td align='right'>
                    <input type='button' class='btn primary' id='addnote' name='addnote' value='Add New'
                           style='float:right'>
                </td>
            </tr>
            <tr>
                    ...
                    <div class="usernotes">
                        <?php if (isset($noteResults) && count($noteResults) > 0) { ?>
                            <table id='ccm-product-list'
                                ...
                                <tbody>
                                <?php foreach ($noteResults as $noteResult) : ?>
