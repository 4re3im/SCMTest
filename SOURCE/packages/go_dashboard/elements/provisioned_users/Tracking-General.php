...
/**
 * Tracking General Tab for Provisioned Users
    ...
    <table width='100%' cellpadding='5' cellspacing='5' border='1'>
        <tr>
            <td align='left'>
                <input
                    type='button'
                    id='reload-tracking-general'
                    class='btn primary' value="<?php echo t('Reload Tracking General')?>"
                />
            </td>
        </tr>
    </table>
...
<div style='clear:both'></div>
 ...
 <div class='panel-default'>
    ...
    <table id='ccm-product-list' class='ccm-results-list' cellspacing='0' cellpadding='0' border='0'>
        ...
        <tbody>
            <?php if (isset($userTrackingGeneral) && !empty($userTrackingGeneral)) { ?>
            <?php foreach ($userTrackingGeneral as $userTrackingGeneralList) { ?>
    ...
    $(function() {
        $('input#reload-tracking-general').click(function(e) {
           var user_id = $('#user_id').val();
            $.ajax({
                type: 'POST',
                data: '&userID=' + user_id + '&is_ajax=yes&func=tracking-general',
