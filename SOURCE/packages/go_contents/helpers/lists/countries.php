...
class ListsCountriesHelper {
	...
	*/
	public function getCountries() {
            // To put Australia and New Zealn in front of the array, we remove it first then unshift it back.
            unset($this->countries['AU'],  $this->countries['NZ']);
            
            $temp['AU'] = 'Australia';
            $temp['NZ'] = 'New Zealand';
            return array_merge($temp, $this->countries);
	}
