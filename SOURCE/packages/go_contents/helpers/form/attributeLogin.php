...
class FormAttributeLoginHelper extends Concrete5_Helper_Form_Attribute
{
    protected $obj;
                            ...
                            $helperPosition = 'before')
    {
        ...
        if ($placeholder) {
            // ANZGO-3957 modified by machua 20181207 to remove space for checkboxes
            switch ($obj->akHandle) {
                case 'uTermsConditions':
                case 'uPMByEmail':
                case 'uPMByRegularPost':
        ...
        switch ($obj->akHandle) {
            ...
            case 'uPassword':
                ...
                $html .= '<ul class="password-req">
                            ...
                            <li class="letter">One (1) letter minimum</li>
                            <li class="number">One (1) number minimum</li>
                        </ul>';
                $html .= '<span class="field-error"></span>';
                break;
            ...
            case 'uPMByEmail':
            case 'uPMByRegularPost':
            // ANZGO-3957 modified by machua 20181207 fix alignment of checkboxes and its corresponding text
                if ($value) {
                    if ($value->getValue()) {
                        $html .= "<input class='" . $obj->akHandle . " checkbox' type='checkbox' 
