...
<script> var myResourceURL = "<?php echo $this->url('/go/myresources_v2'); ?>";</script>
                    ...
                    <div class="col-md-12">
                        <div class="breadcrumbs">
                            <ol>
                                ...
                                <?php } ?>
                                <li><a href="/go/myresources_v2/" class="active" style="pointer-events: none;">My resources</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<div id="more-titles" class="text-center load"></div>
<?php
