    ...
    <div class="clearfix">
        ...
        <div class="input">
            <ul class="inputs-list">
                <li>
                    <label>
                        <?php echo $form->radio('announcementMode', '1', $announcementMode)?>
                        <span><?php echo t('Enabled')?></span>
                    </label>
                </li>
                <li>
                    <label>
                        <?php echo $form->radio('announcementMode', '0', $announcementMode)?>
    ...
    <div class="clearfix">
        ...
        <div class="input">
            <ul class="inputs-list">
                <li>
                    <label>
                        <?php echo $form->textarea('bannerMessage', $bannerMessage); ?>
                    </label>
                </li>     
           </ul>
        </div>
    ...
    <div class="clearfix">
        ...
        <div class="input">
            <div style=' margin-bottom:5px;'>
                <?php Loader::packageElement('countries', 'go_contents'); ?>
