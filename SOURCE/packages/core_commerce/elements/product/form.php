...
<div class="input">
	<?php echo $form->text('prName', $prName, array('class' => "span10"))?>
</div>
</div>
...
<div class="input">
	...
	<?php echo $form->textarea('prDescription', $prDescription, array('style' => 'height: 150px; width: 100%', 'class' => 'ccm-advanced-editor'))?>
	</div>
</div>
</div>
...
<div class="clearfix">
<label><?php echo t('Place customers in user group: ')?></label>
<div class="input">
<ul class="inputs-list">
<?php 
