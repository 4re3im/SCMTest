	...
	<?php 
		...
		foreach($products as $pr) { 
			...
			if ($mode == 'choose_one') { 
				...
				$action = 'javascript:void(0); ccm_coreCommerceSelectProductMultiple(' . $pr->getProductID() . ', \'' . htmlentities($pr->getProductName(), ENT_QUOTES, APP_CHARSET) . '\'); jQuery.fn.dialog.closeTop();';
			} else {
