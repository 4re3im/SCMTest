...
$body .= $blurb . "\n\n";
//Log::addEntry(var_export($products,true));
...
if(isset($orderHistoryLink) && strlen($orderHistoryLink)) {
	$body .= "\n";
	$body.= t('You can view your entire order history here:')."\n";
	$body .= $orderHistoryLink;
}
