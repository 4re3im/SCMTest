...
<div class="ccm-block-field-group">
	...
	<?php echo  $form->checkbox('options[hide_sold_out]',1,$options['hide_sold_out']); ?>
	&nbsp;&nbsp;
	<?php echo  $form->label('options[hide_sold_out]', t('Hide products that are sold out.')); ?>
</div>
<div class="ccm-block-field-group">
<h4><?php echo t('Results Layout')?></h4>
...
<h4><?php echo t('Paging & Sorting')?></h4>
<?php  

if ($numResults == '') {
	$numResults = 10;
} ?>
<?php echo  t('Show') ?> <?php echo $form->text('numResults', $numResults, array('style' => 'width:35px'))?> <?php echo  t('per page') ?><br />
<br />
