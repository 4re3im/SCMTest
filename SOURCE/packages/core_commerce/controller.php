...
class CoreCommercePackage extends Package {
	...
	protected $singlePages = array(
		'/education/cart',
		'/education/checkout',
		'/education/checkout/discount',
		'/education/checkout/billing',
		'/education/checkout/shipping',
		'/education/checkout/shipping/address',
		'/education/checkout/shipping/method',
		'/education/checkout/payment',
		'/education/checkout/payment/method',
		'/education/checkout/payment/form',
		'/education/checkout/finish',
		'/education/checkout/finish_error',
		'/education/checkout/complete_order',
		'/education/profile/order_history',
	...
	public function install($options = 'yes') {
		...
		SinglePage::add('/checkout/complete_order', $pkg);
		...
		SinglePage::add('/dashboard/core_commerce/products/sets', $pkg);
		...
		$c2 = SinglePage::add('/profile/order_history', $pkg);
		$c2->update(array('cName'=>t('Order History')));
         *  
         */
...
/*
		...
		*/
		...
		/*** Custom Stuff ****/
		// $pkg = parent::install(); Commented out as it disrupts installation
		Loader::model('shipping/type', 'core_commerce');
		//CoreCommerceShippingType::add('flat', t('Flat Shipping'), 1);
		CoreCommerceShippingType::add('aus_flat', t('Flat Shipping AUS'), 0, $pkg);
		CoreCommerceShippingType::add('nz_flat', t('Flat Shipping NZ'), 0, $pkg);
	}
