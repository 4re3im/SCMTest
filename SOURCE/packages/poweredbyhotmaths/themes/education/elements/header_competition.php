...
/**
 * Header Competition for Education Theme
 */

?>
<div id="global-nav">
    <ul id="nav">
        <?php $cup_logo_url = BASE_URL.DIR_REL.'/themes/cup/images/cup/logo.jpg'; ?>
        <li class="logo">
            <a href="http://www.cambridge.org">
                <img alt="Cambridge University Press logo" src="<?php echo $cup_logo_url;?>">
            </a>
        </li>
        <li>
            <a href="http://www.cambridge.org/aus/browse/academic.asp?site_locale=en_AU&amp;prefCountry=AU">Academic</a>
        </li>
        ...
        <li class="drop"><a href="http://www.cambridge.org/about-us/">About Us&nbsp;&nbsp;</a>
            <ul>
                ...
                <li>
                    <a href="http://www.cambridge.org/about-us/what-we-do/cambridge-conference-facilities">
                        Conference Venues
                    </a>
                </li>
