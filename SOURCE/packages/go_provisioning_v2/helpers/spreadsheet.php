...
class SpreadsheetHelper
{
    ...
    {
        Loader::library('SpreadsheetReader/php-excel-reader/excel_reader2', 'go_provisioning_v2');
        Loader::library('SpreadsheetReader/SpreadsheetReader', 'go_provisioning_v2');
