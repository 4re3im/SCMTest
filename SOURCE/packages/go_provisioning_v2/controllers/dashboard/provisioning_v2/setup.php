...
class DashboardProvisioningV2SetupController extends Controller
{
    ...
    public function provision($fileRecordId, $offset = 0)
    {
        ...
        for ($x=0; $x < static::PROVISION_LIMIT; $x++){
            ...
            if (isset($hmMeta['products']) || !is_null($class)) {
                $params = array();
        ...
        // );
        $resultTable = $this->displayUsers(0, $this->fileRecordId, true);
        echo json_encode([
            'table' => $resultTable
        ]);
        exit;
