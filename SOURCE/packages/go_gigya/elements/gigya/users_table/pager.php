...
<ul>
    ...
    <?php if(!$inFirstChunk && !$inFirstPage) { ?>
        <li class="numbers gigya-page">
            <a href="/dashboard/gigya/users/navigateTable/1" data-page="1">1</a>
        </li>
    <?php }?>

    <?php if($activePage > $displayLimit) { ?>
        <li class="ccm-pagination-ellipses gigya-page">
            <a href="/dashboard/gigya/users/navigateTable/<?php echo $firstPageOfPreviousChunk; ?>">...</a>
        </li>
    <?php }?>
    ...
    foreach ($pages as $page) {
        ...
        <li class="numbers <?php echo ($page === $activePage) ? 'disabled' : ''?> gigya-page">
            <a href="/dashboard/gigya/users/navigateTable/<?php echo $page; ?>" data-page="<?php echo $page; ?>"><?php echo $page; ?></a>
        </li>
    <?php } ?>

    <?php if(!$inLastPage && !$inLastChunk) { ?>
        <li class="ccm-pagination-ellipses gigya-page">
            <a href="/dashboard/gigya/users/navigateTable/<?php echo max($pages) + 1; ?>">...</a>
        </li>
    <?php }?>

    <?php if($totalCount > 0 && (!$inLastPage && !$inLastChunk)) { ?>
        <li class="numbers <?php echo ($inLastPage) ? 'disabled' : ''?> gigya-page">
            <a href="/dashboard/gigya/users/navigateTable/<?php echo $totalPages; ?>" data-page="<?php echo $totalPages; ?>"><?php echo $totalPages; ?></a>
        </li>
    <?php } ?>
