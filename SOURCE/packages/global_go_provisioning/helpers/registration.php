...
class RegistrationHelper
{
    ...
    public function cleanData($data)
    {
        ...
        foreach ($data as $key => $value) {
            switch ($key) {
                case static::COLUMN_CLASS_NAME_INT_MATH:
                case static::COLUMN_CLASS_NAME_HUMANITIES:
                case static::COLUMN_CLASS_NAME_ICEEM:
                    $cleanedData[$key] = $value;
                    break;
                case static::COLUMN_FIRST_NAME:
                case static::COLUMN_LAST_NAME:
                    $string = str_replace(' ', '', trim($value));
                    $string = htmlspecialchars($string);
                    $cleanedData[$key] = $string;
                    break;
                case static::COLUMN_EMAIL:
                    $cleanedData[$key] = strtolower($value);
                    break;
                default:
