...
sql;
     ...
     */
    public function setHotMathsAPI($user = '', $hmID = '', $responseType = '', $customUserType = null)
    {
        $this->api = new HMUser(
            array(
                'user' => $user,
     ...
     * @return mixed
     */
    public function provisionUserInHotMaths($provisioningUser, $schoolId, $classNames, $products = null)
    {
        $this->setHotMathsAPI($provisioningUser, '', 'JSON');
        ...
        return $this->api->createGlobalGoHmUser($additionalUserDetails);
    }
    ...
    {
        $hmUser = $this->api->getUserByUsername();
    ...
    public function getHmUserByUsername()
    {
