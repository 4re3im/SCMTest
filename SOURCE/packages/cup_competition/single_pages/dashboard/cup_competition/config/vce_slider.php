...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('VCE Slider Config'), false);?>
<?php Loader::packageElement('alert_message_header', 'cup_competition'); ?>
<form method="post" action="<?php echo $this->url('/dashboard/cup_competition/config/vce_slider')?>">
