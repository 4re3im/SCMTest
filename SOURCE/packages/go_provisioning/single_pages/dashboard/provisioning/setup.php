...
$url = $th->getToolsURL('autocomplete', 'go_provisioning');
...
<div class="ccm-ui">
    <div class="ccm-pane">
        ...
        <div class="ccm-pane-body">
            ...
            <div class="row">
                <div class="span11">
                    ...
                    <form id="subscriptions-form" method="POST"
                          action="<?php echo $this->url('/dashboard/provisioning/setup/startProvisioning'); ?>"
            ...
            <div class="row">
                <div class="span11">
                    <form action="/dashboard/provisioning/setup/exportToSheet/" method="POST">
