...
function postSubmitForm (data) {
  ...
  for (var i = 0; i < data.pages; i++) {
    addAjax({
      url: '/dashboard/provisioning/setup/provision/' + data.fileRecordId + '/' + i,
      type: 'POST',
      dataType: 'json',
      data: postData,
...
function provisionInGigya () {
  ...
  $.ajax({
    url: '/dashboard/provisioning/setup/provisionInGigya/' + fileRecordId + '/' + providerId,
    type: 'POST',
    dataType: 'json',
    beforeSend : function(){
...
function checkJobStatus (scheduleId) {
  $.ajax({
    url : '/dashboard/provisioning/setup/getJobStatus/' + scheduleId,
    type : 'GET',
    dataType: 'json',
    beforeSend : function(){
...
function checkUsersInGigya () {
  ...
  var providerId = $('#providerId').val();
  $.ajax({
    url: '/dashboard/provisioning/setup/updateGigyaStatus/' + fileRecordId + '/' + providerId,
    type: 'POST',
    dataType: 'json',
    beforeSend: function(){
...
function checkGigyaProvisionStatus () {
  $.ajax({
    url: '/dashboard/provisioning/setup/getGigyaProvisioningStatus/' + fileRecordId,
    type: 'POST',
    dataType: 'json',
    success: function (data) {
      if (!data.isDone) {
...
function refreshResult (fileRecordId, successCallback) {
  $.ajax({
    url: '/dashboard/provisioning/setup/displayUsers/' + 1 + '/' + fileRecordId,
    type: 'POST',
    dataType: 'json',
