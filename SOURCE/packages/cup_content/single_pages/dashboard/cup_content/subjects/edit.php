...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Edit Subject'), false)?>
<?php Loader::packageElement('alert_message_header', 'cup_content'); ?>

<form method="post" id="ccm-core-commerce-product-add-form" action="<?php echo $this->url('/dashboard/cup_content/subjects/edit', $entry['id'])?>">
<div class="ccm-pane-body">
    <?php echo $valt->output('edit_author')?>
    <?php Loader::packageElement('subject/form', 'cup_content', array('entry'=>$entry)); ?>
</div>
