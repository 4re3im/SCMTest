...
<?php echo Loader::helper('concrete/dashboard')->getDashboardPaneHeaderWrapper(t('Downloadable File'), false)?>
...
<div class="ccm-pane-body">
	...
	<?php Loader::packageElement('title_downloadable_file/form', 'cup_content', array('entry'=>@$entry)); ?>
</div>
<div class="ccm-pane-footer">
	<input type="hidden" name="create" value="1" />
	<input id="cc-parent-page" type="hidden" name="parentCID" value="0" />
	<a href="<?php echo $this->url('/dashboard/cup_content/titles/show', $titleID)?>" class="btn"><?php echo t('Back to Title')?></a>
