...
<form method="post" action="<?php echo $this->url('/dashboard/cup_content/block_main_carousel_config/edit')?>">
		...
		<tr>
			...
			<td><?php echo $form->select('interval', 
									array('4'=>'4', '5'=>'5', '6'=>'6', 
										...
										'10'=>'10', '15'=>'15', '20'=>'20',
										'25'=>'25', '30'=>'30' ),
									$carousel_config['interval'])?> sec</td>
		</tr>
	</table>
...
<a href="<?php echo $this->url('/dashboard/cup_content/block_main_carousel_config')?>" class="btn"><?php echo t('Back')?></a>
