...
class PHPExcel_IOFactory
{
	...
	public static function createWriter(PHPExcel $phpExcel, $writerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				...
				//$class_path = $currentFilepath.DIRECTORY_SEPARATOR.'Writer'.DIRECTORY_SEPARATOR.$writerType.'.php';
	...
	public static function createReader($readerType = '') {
		...
		foreach (self::$_searchLocations as $searchLocation) {
			if ($searchLocation['type'] == $searchType) {
				//$currentFilepath = dirname(__FILE__);
				//$class_path = $currentFilepath.DIRECTORY_SEPARATOR.'Reader'.DIRECTORY_SEPARATOR.$readerType.'.php';
				//require_once($class_path);
