...
<?php $wform = Loader::helper('wform', 'cup_content');
		...
		$dashboard_select_format_link = $uh->getToolsURL('author/dashboard_selection', 'cup_content');
?>
<div style="width:600px;height:470px;">
	...
	<div class="float_left">
		<div style="margin: 0px 10px">Selected Authors</div>
	...
	<div class="float_left">
		<div style="margin: 0px 10px">Available Authors</div>
	...
	<div>
		<?php echo $wform->button('Confirm', 'javascript:applyAuthorValue();', array('style'=>'font-size:9px;'), 'blue');?>
	</div>
</div>
...
<script>
	...
	*/
	...
	var applyAuthorValue = function(){
		var html_code = "";
		
		var temp_value = "";
		var temp_hidden_field = "";
		var temp_value_item = "";
		var fieldname = 'authors[]';
		...
		jQuery('.multiple-items-group[ref="authors"]').empty();
		jQuery('.multiple-items-group[ref="authors"]').append(jQuery(html_code));
